...
if image_based:
    ...
    env = football_env.create_environment(env_name='academy_3_vs_1_with_keeper', representation='simple115v2', render=False, rewards='scoring', number_of_left_players_agent_controls=3)
...
while not target_reached and iters < max_iters:
    ...
    if not iters % 200:  # save actor models in increments of 200
        model_actor.save('models/3vs1_three_5M_explore/model_actor_{}_{}.hdf5'.format(iters, iter_rewards[0]))
        model_critic.save('models/3vs1_three_5M_explore/model_critic_{}_{}.hdf5'.format(iters, iter_rewards[0]))
