...
def build_scenario(builder):
  ...
  builder.config().right_team_difficulty = 0
  ...
  builder.AddPlayer(0.000000, -0.020000, e_PlayerRole_CF, lazy=True)
  builder.AddPlayer(-0.1,  0.1, e_PlayerRole_CB, lazy=True)
